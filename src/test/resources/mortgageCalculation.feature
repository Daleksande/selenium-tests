...
Функционал: Страхование
  ...
  Сценарий: Расчет ипотеки
    ...
    * проверяю, что элемент "Общая сумма выплат" содержит текст "4 836 819.11 руб."
    * проверяю, что элемент "Cумма выплат по процентам" содержит текст "1 836 819.11 руб."
    * проверяю, что элемент "Процентная ставка" содержит текст "10.49 %"
